...
/var/log/my-cool-api
%attr(755, my-cool-api, my-cool-api) /etc/systemd/system/my-cool-api/other-scripts/my-script.js
%attr(755, my-cool-api, my-cool-api) /etc/systemd/system/my-cool-api/scripts
